            ...
            <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
                <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                    <div className="sm:max-w-lg">
                        <h1 className="font text-4xl font-bold tracking-tight text-base-content sm:text-6xl">Summer styles are finally here</h1>
                        <p className="mt-4 text-xl text-base-content text-opacity-70">This year, our new summer collection will shelter you from the harsh elements of a world that doesn't care if you live or die.</p>
                    </div>
                    <div>
                        <div className="mt-10">
                            ...
                            <a href="#" className="btn btn-primary btn-wide">Shop Collection</a>
                        </div>
                    </div>
                </div>
            </div>
