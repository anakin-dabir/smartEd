...
const Comment = () => {
    return (
        <section className="relative flex items-center justify-center min-h-screen antialiased bg-white min-w-screen">
            <div className="container px-0 mx-auto sm:px-5">
                <div className="flex-col w-full py-4 mx-auto  border-b-2 border-r-2  sm:px-4 sm:py-4 md:px-4 sm:rounded-lg shadow-lg md:w-2/3">
                    ...
                    <div className="flex flex-row pt-1 md-10 md:ml-16">
                        ...
                        <div className="flex-col mt-1">
                            ...
                            <div className="flex-1 px-2 ml-2 text-sm font-medium leading-loose text-gray-600">I created it using
                                TailwindCSS
                            </div>
                            <button className="inline-flex items-center px-1 pt-2 ml-1 flex-column">
                                <svg className="w-5 h-5 ml-2 text-gray-600 cursor-pointer fill-current hover:text-gray-900" viewBox="0 0 95 78" xmlns="http://www.w3.org/2000/svg">
